 ...
 *
 */
public class WorkerParallelismOrderSumTopology {
    ...
    public static void main(String[] args) throws  Exception {
        ...
        //Topology名称
        String topologyName = WorkerParallelismOrderSumTopology.class.getSimpleName();
        //storm配置信息
        Config config = new Config();
        //之前1个worker的时候，有3个executor 3个task
        /*
            2个worker的时候 2个executor 6task | 3个executor 3个task
            为什么是2个worker 4个executor 4个task
            2个worker是因为我们设置NumWorkers(2)
            而为什么是4个executor？
                3个executor+1__acker对应的excutor
                3个executor为之前的一个worker对应的executor
                剩下的一个__acker为系统对该worker启动的系统组件，也就是说，系统会为worker默认启动1个__acker executor
            为什么不是6个executor，原因在于资源的分配
         */
