 ...
 *
 */
public class ExecutorParallelismOrderSumTopology {
    ...
    public static void main(String[] args) throws  Exception {
        ...
        tb.setSpout("id_spout", new NumSpout(), 2);//使用重载的函数用来设置executor的并行度
        tb.setBolt("id_bolt", new OrderBolt(), 2).shuffleGrouping("id_spout");//流分组

        //第二步：使用TopologyBuilder构建Topology
        StormTopology stormTopology = tb.createTopology();
        //第三步：提交作业，可以使用集群模式、本地模式
        //Topology名称
        String topologyName = ExecutorParallelismOrderSumTopology.class.getSimpleName();
        //storm配置信息
