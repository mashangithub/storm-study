 ...
 *  3 bolt executor
 */
public class FieldsGroupingFileWordsTopology {
...
//            input.getStringByField("line");
    ...
    static class WCBolt extends BaseRichBolt {
        ...
        public void execute(Tuple input) {//读到的就是SplitBolt发送过来的word和count数据
            ...
            System.out.println("=======id==>"+ id +" word: " + word +">>>>=======统计结果========================");
            map.forEach((k, v) -> {
                System.out.println(k + ">=id: + id + ==>" + v);
            });
            System.out.println("=============================================");
        }
    ...
    public static void main(String[] args) {
        ...
        tb.setBolt("id_statis_bolt", new WCBolt(), 3).fieldsGrouping("id_split_bolt", new Fields("word"));

        StormTopology stormTopology = tb.createTopology();

        LocalCluster lc = new LocalCluster();
        String topologyName = FieldsGroupingFileWordsTopology.class.getSimpleName();
