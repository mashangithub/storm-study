...
/**
 * 流分组之localOrShuffleGrouping：
 *  通ShuffleGrouping
 *  假设上游有1个spout对应executor
 *      下游有3个bolt对应的executor
 *
 */
public class LocalOrShuffleGroupingRealTimeOrderSumTopology {
    ...
    public static void main(String[] args) throws  Exception {
        ...
        tb.setBolt("id_bolt", new OrderBolt(), 3).localOrShuffleGrouping("id_spout");//流分组

        //第二步：使用TopologyBuilder构建Topology
        StormTopology stormTopology = tb.createTopology();
        //第三步：提交作业，可以使用集群模式、本地模式
        //Topology名称
        String topologyName = LocalOrShuffleGroupingRealTimeOrderSumTopology.class.getSimpleName();
        //storm配置信息
