 ...
 *
 */
public class DireactGroupingRealTimeOrderSumTopology {
    ...
    static class NumSpout extends BaseRichSpout {
        ...
        public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
            ...
            List<Integer> taskIds = context.getComponentTasks("id_bolt");
...
//            this.collector.emit(new Values(num++));
            this.collector.emitDirect(taskId , new Values(num++));
    ...
    public static void main(String[] args) throws  Exception {
        ...
        tb.setBolt("id_bolt", new OrderBolt(), 3).directGrouping("id_spout");//流分组

        //第二步：使用TopologyBuilder构建Topology
        StormTopology stormTopology = tb.createTopology();
        //第三步：提交作业，可以使用集群模式、本地模式
        //Topology名称
        String topologyName = DireactGroupingRealTimeOrderSumTopology.class.getSimpleName();
        //storm配置信息
